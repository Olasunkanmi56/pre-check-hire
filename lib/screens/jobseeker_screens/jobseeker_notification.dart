...
class JobSeekerNotificationScreen extends StatefulWidget {
  const JobSeekerNotificationScreen({super.key});

  @override
  State<JobSeekerNotificationScreen> createState() =>
      _JobSeekerNotificationScreenState();
}

class _JobSeekerNotificationScreenState
    extends State<JobSeekerNotificationScreen> {
  int selectedTab = 0;
