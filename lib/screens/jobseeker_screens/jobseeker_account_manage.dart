...
class JobSeekerAccountManagementScreen extends StatefulWidget {
  const JobSeekerAccountManagementScreen({super.key});

  @override
  State<JobSeekerAccountManagementScreen> createState() =>
      _JobSeekerAccountManagementScreenState();
}

class _JobSeekerAccountManagementScreenState
    extends State<JobSeekerAccountManagementScreen> {
  int selectedTab = 0;
  File? _profileImage;
  File? _frontImage;
  File? _backImage;
