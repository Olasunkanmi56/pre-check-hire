...
class EmployerHelpCenterScreen extends StatefulWidget {
  const EmployerHelpCenterScreen({super.key});

  @override
  State<EmployerHelpCenterScreen> createState() =>
      _EmployerHelpCenterScreenState();
}

class _EmployerHelpCenterScreenState extends State<EmployerHelpCenterScreen> {
  int selectedTab = 0;
