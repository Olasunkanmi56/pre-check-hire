...
class EmployerForgotPasswordScreen extends StatefulWidget {
  const EmployerForgotPasswordScreen({super.key});

  @override
  State<EmployerForgotPasswordScreen> createState() =>
      _EmployerForgotPasswordScreenState();
}

class _EmployerForgotPasswordScreenState
    extends State<EmployerForgotPasswordScreen> {
                            ...
                            if (_formKey.currentState!.validate()) {
                              ...
                              try {
                                ...
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => EmployerResetPasswordScreen(email: _emailController.text),
                                  ),
                                );
                              } catch (e) {
                  ...
                  child: Text.rich(
                    TextSpan(
                      ...
                      children: [
                        TextSpan(
                          text: 'Sign in',
                          style: TextStyle(fontSize: 12.sp, fontWeight: FontWeight.w500, color: Color(0XFFFB0206)),
