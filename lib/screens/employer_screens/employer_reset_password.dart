...
class EmployerResetPasswordScreen extends StatefulWidget {
  const EmployerResetPasswordScreen({super.key});

  @override
  State<EmployerResetPasswordScreen> createState() =>
      _EmployerResetPasswordScreenState();
}

class _EmployerResetPasswordScreenState
    extends State<EmployerResetPasswordScreen> {
