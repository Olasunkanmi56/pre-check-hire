...
class BlacklistAccountManagementScreen extends StatefulWidget {
  const BlacklistAccountManagementScreen({super.key});

  @override
  State<BlacklistAccountManagementScreen> createState() =>
      _BlacklistAccountManagementScreenState();
}

class _BlacklistAccountManagementScreenState
    extends State<BlacklistAccountManagementScreen> {
  int selectedTab = 0;
  File? _profileImage;
  File? _frontImage;
  File? _backImage;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 8.h),
            Text("Blacklist Viewer", style: TextStyle(fontSize: 13.sp)),
            SizedBox(height: 16.h),
            // Container(
            //   height: 40.h,
            //   decoration: BoxDecoration(
            ...
            if (selectedTab == 0) ...[
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {},
                  child: Text("Update", style: TextStyle(fontSize: 14.sp, color: Colors.white)),
                ),
              ),
              SizedBox(height: 24.h),
            ] else ...[
