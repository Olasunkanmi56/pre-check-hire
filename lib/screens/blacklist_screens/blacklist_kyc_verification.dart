...
class BlacklistKycVerifictionScreen extends StatefulWidget {
  const BlacklistKycVerifictionScreen({super.key});

  @override
  State<BlacklistKycVerifictionScreen> createState() =>
      _BlacklistKycVerifictionScreenState();
}

class _BlacklistKycVerifictionScreenState
    extends State<BlacklistKycVerifictionScreen> {
  int selectedTab = 0;
  File? _profileImage;
  File? _frontImage;
  File? _backImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Kyc Verification", style: TextStyle(color: Colors.black, fontSize: 16.sp)),
      ),
