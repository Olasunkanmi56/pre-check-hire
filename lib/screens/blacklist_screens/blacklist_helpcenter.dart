...
class BlacklistHelpCenterScreen extends StatefulWidget {
  const BlacklistHelpCenterScreen({super.key});

  @override
  State<BlacklistHelpCenterScreen> createState() =>
      _BlacklistHelpCenterScreenState();
}
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                ...
                //   context,
                //   MaterialPageRoute(
                //     builder: (context) => const EmployerFilterScreen(),
                //   ),
                // );
              },
              child: Container(
      ...
      child: Column(
        ...
        children: [
          _buildContactItem(
            ...
            onTap: () {
              Clipboard.setData(
                const ClipboardData(text: "6th Avenue, Wall Street, New York"),
              );
          ...
          _buildContactItem(
            ...
            onTap: () {
              Clipboard.setData(const ClipboardData(text: "+1 234 567 890"));
          ...
          _buildContactItem(
            ...
            onTap: () {
              Clipboard.setData(
                const ClipboardData(text: "help@precheckhire.com"),
              );
              ScaffoldMessenger.of(context).showSnackBar(
